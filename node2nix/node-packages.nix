...
let
  sources = {
    ...
    "@types/node-24.8.0" = {
      ...
      version = "24.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-24.8.0.tgz";
        sha512 = "5x08bUtU8hfboMTrJ7mEO4CpepS9yBwAqcL52y86SWNmbPX8LVbNs3EP4cNrIZgdjk2NAlP2ahNihozpoZIxSg==";
      };
    };
