...
let
  sources = {
    "@a2a-js/sdk-0.3.10" = {
      ...
      version = "0.3.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@a2a-js/sdk/-/sdk-0.3.10.tgz";
        sha512 = "t6w5ctnwJkSOMRl6M9rn95C1FTHCPqixxMR0yWXtzhZXEnF6mF1NAK0CfKlG3cz+tcwTxkmn287QZC3t9XPgrA==";
      };
    };
    ...
    "@google/gemini-cli-core-0.29.1" = {
      name = "_at_google_slash_gemini-cli-core";
      packageName = "@google/gemini-cli-core";
      version = "0.29.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@google/gemini-cli-core/-/gemini-cli-core-0.29.1.tgz";
        sha512 = "BlNE4vvCbH2TwTsUNLZZPq/BqqLCvxesv8MPICfsjglKAWHsZPM6QabqMNHC0BujvSkWMbcMU8YPb9VgAsQ3TA==";
      };
    };
    "@google/genai-1.30.0" = {
    ...
    "@modelcontextprotocol/sdk-1.27.0" = {
      ...
      version = "1.27.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@modelcontextprotocol/sdk/-/sdk-1.27.0.tgz";
        sha512 = "qOdO524oPMkUsOJTrsH9vz/HN3B5pKyW+9zIW51A9kDMVe7ON70drz1ouoyoyOcfzc+oxhkQ6jWmbyKnlWmYqA==";
      };
    };
    ...
    "hono-4.11.10" = {
      ...
      version = "4.11.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/hono/-/hono-4.11.10.tgz";
        sha512 = "kyWP5PAiMooEvGrA9jcD3IXF7ATu8+o7B3KCbPXid5se52NPqnOpM/r9qeW2heMnOekF4kqR1fXJqCYeCLKrZg==";
      };
    };
    ...
    "ink-6.4.8" = {
      ...
      version = "6.4.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/@jrichman/ink/-/ink-6.4.8.tgz";
        sha512 = "v0thcXIKl9hqF/1w4HqA6MKxIcMoWSP3YtEZIAA+eeJngXpN5lGnMkb6rllB7FnOdwyEyYaFTcu1ZVr4/JZpWQ==";
      };
    };
    "ink-gradient-3.0.0" = {
      name = "ink-gradient";
    ...
    "macos-version-6.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "O2S8voA+pMfCHhBn/TIYDXzJ1qNHpPDU32oFxglKnVdJABiYYITt45oLkV9yhwA3E2FDwn3tQqUFrTsr1p3sBQ==";
      };
    };
    "marked-15.0.12" = {
      name = "marked";
    ...
    "run-jxa-3.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "4f2CrY7H+sXkKXJn/cE6qRA3z+NMVO7zvlZ/nUV0e62yWftpiLAfw5eV9ZdomzWd2TXWwEIiGjAT57+lWIzzvA==";
      };
    };
    "safe-buffer-5.2.1" = {
      name = "safe-buffer";
    ...
    "subsume-4.0.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "BWnYJElmHbYZ/zKevy+TG+SsyoFCmRPDHJbR1MzLxkPOv1Jp/4hGhVUtP98s+wZBsBsHwCXvPTP0x287/WMjGg==";
      };
    };
    ...
    "systeminformation-5.31.1" = {
      ...
      version = "5.31.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/systeminformation/-/systeminformation-5.31.1.tgz";
        sha512 = "6pRwxoGeV/roJYpsfcP6tN9mep6pPeCtXbUOCdVa0nme05Brwcwdge/fVNhIZn2wuUitAKZm4IYa7QjnRIa9zA==";
      };
    };
    "tar-7.5.9" = {
      name = "tar";
...
in
{
  "@anthropic-ai/claude-code" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "RuVCBdSad+tsYsSt8W2s1BICHfulLnj73YqexH8gHgFlOP7mNZOtlGod5UEdrPotedYwiDzKx3L0BiB39YNWPg==";
    };
  ...
  "@google/gemini-cli" = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "dmf/XaRz7ta+8fLObPA5xrOO2wTRU+WEmxrqiSYAKZ8hYfGMEpunOjjRK8zs+47nObuLjo3ilxlJeFDKqs1eng==";
    };
    dependencies = [
      (
        sources."@a2a-js/sdk-0.3.10"
        // {
          dependencies = [
            sources."uuid-11.1.0"
          ];
      ...
      (
        sources."@google/gemini-cli-core-0.29.1"
        // {
          dependencies = [
            (
              sources."gaxios-6.7.1"
      ...
      sources."@modelcontextprotocol/sdk-1.27.0"
      ...
      sources."systeminformation-5.31.1"
      sources."tar-7.5.9"
      (
